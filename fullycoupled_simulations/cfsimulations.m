%Run coupled ice-sheet/sea-level simulation for calving front only
%perturbation
...
% script names
S1='cfcoupled_slr.m';
S2='cfsealevel_icethickness1.m';
S4='cfsealevel_icethickness_cycle.m';
S5='cfcoupled_slr_cycle.m';
