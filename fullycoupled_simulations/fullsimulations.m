%Run coupled ice-sheet/sea-level simulation for full domain
%perturbation
...
% script names
S1='fullcoupled_slr.m';
S2='fullsealevel_icethickness1.m';
S4='fullsealevel_icethickness_cycle.m';
S5='fullcoupled_slr_cycle.m';
