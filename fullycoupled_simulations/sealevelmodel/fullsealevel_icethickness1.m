...
org=organizer('repository','Models','prefix', sprintf('fullSlr_%d_THICKNESS1_', sigma),'steps',steps);
...
if perform(org,'Loads'),  
	...
	mds = loadmodel(sprintf('../icesheetmodel/ModelsSeaTest/fullSlr_%d_fromobs', sigma)); %initial 1 year simulation
...
if perform(org,'Transient'),
	...
	md.miscellaneous.name=sprintf('fullSlr_%d_THICKNESS1_Transient', sigma);
